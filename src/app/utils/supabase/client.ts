...
// Todo el tráfico de Supabase pasa por el proxy nginx en EasyPanel
// para evitar restricciones de red en el navegador del usuario.
const SUPABASE_URL = 'https://remolques-remolques-supa.gehkp3.easypanel.host';
