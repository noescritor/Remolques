...
export function CotizacionesList({
  ...
  // Proteger contra arrays nulos o indefinidos
    ...
    return (
      <div className="space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-50 border-b border-gray-200 h-14">
  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <Button onClick={onNuevaCotizacion} className="bg-[#0b5fff] hover:bg-[#0b5fff]/90 w-full sm:w-auto">
      ...
      {cotizacionesFiltradas.length === 0 ? (
        <div className="bg-white border border-gray-200 rounded-lg p-12 text-center">
          ...
          {!busqueda && filtroEstado === 'todos' && (
            <Button onClick={onNuevaCotizacion} className="bg-[#0b5fff] hover:bg-[#0b5fff]/90">
              <Plus className="mr-2 h-4 w-4" />
              Nueva Cotización
            </Button>
          )}
